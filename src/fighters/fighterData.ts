...
export const FIGHTERS: FighterConfig[] = [
  {
    ...
    attacks: {
      ...
      ultimate: makeAttack('ultimate', {
        name: 'Golden Rush',
        description:
          'Robin ignites and charges across the stage, landing a blinding flurry on everyone in his path.',
        damage: 5,
        hitInterval: 0.1,
        surge: true,
        active: 0.55,
  ...
  },
  {
    ...
    attacks: {
      ...
      ultimate: makeAttack('ultimate', {
        ...
        description:
          'A true whirlwind — foes are dragged into the vortex and shredded by a storm of kicks.',
        damage: 3.5,
        hitInterval: 0.09,
        vacuum: true,
        active: 0.6,
        baseKnockback: 4,
        knockbackScaling: 0.2,
        angle: Math.PI * 0.35,
      }),
    },
  },
  ...
  },
  {
    ...
    attacks: {
      ...
      ultimate: makeAttack('ultimate', {
        name: 'Sky Storm',
        description:
          'Till spirals into the sky, dragging anyone he clips upward with him — a rising cyclone that ends dangerously close to the top blast zone.',
        damage: 4.5,
        hitInterval: 0.12,
        riseSelf: true,
        angle: Math.PI * 0.5,
