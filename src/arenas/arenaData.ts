...
const SPECS: ArenaSpec[] = [
  ...
  },
  {
    ...
    platforms: [
      ...
      { x: -5.5, y: 3.7, width: 5, height: 0.6, passThrough: true },
      { x: 5.5, y: 3.7, width: 5, height: 0.6, passThrough: true },
    ],
  ...
  },
  {
    ...
    platforms: [
      ...
      { x: 5, y: 3.7, width: 4, height: 0.6, passThrough: true },
      { x: -2, y: 6.2, width: 3.5, height: 0.6, passThrough: true },
    ],
  ...
  },
  {
    ...
    platforms: [
      ...
      { x: -7, y: 3.7, width: 4.5, height: 0.7, passThrough: false },
      { x: 7, y: 3.7, width: 4.5, height: 0.7, passThrough: false },
      { x: 0, y: 6.6, width: 3.2, height: 0.6, passThrough: true },
    ],
